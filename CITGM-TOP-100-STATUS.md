...
fresh full Chromium rerun now times out during virtual `npm install`, before
the package test lifecycle. Firefox must distinguish whether that timeout is
engine-specific or shared.
