...
work forward in rank order. The status table is the source of truth for the
next candidate; re-check it before each run because the cursor changes after
every committed CITGM result.
